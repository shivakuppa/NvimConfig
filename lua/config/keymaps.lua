...
-- ===
-- This file is automatically loaded by shiva.config.init

local ShivaUtil = require('shiva.util')
...
map('n', ']s', function() ShivaUtil.edit.whitespace_jump(1) end, { desc = 'Next Whitespace' })
map('n', '[s', function() ShivaUtil.edit.whitespace_jump(-1) end, { desc = 'Previous Whitespace' })
...
map(
	'x',
	'<C-r>',
	":<C-u>%s/\\V<C-R>=v:lua.require'shiva.util.edit'.get_visual_selection()<CR>"
		.. '//gc<Left><Left><Left>',
...
map('n', '<Leader>ml', function() ShivaUtil.edit.append_modeline() end, { desc = 'Append Modeline' })

-- Jump entire buffers throughout jumplist
map('n', 'g<C-i>', function() ShivaUtil.edit.jump_buffer(1) end, { desc = 'Jump to newer buffer' })
map('n', 'g<C-o>', function() ShivaUtil.edit.jump_buffer(-1) end, { desc = 'Jump to older buffer' })

-- Context aware menu. See lua/lib/contextmenu.lua
map('n', '<RightMouse>', function() ShivaUtil.contextmenu.show() end)
map('n', '<LocalLeader>c', function() ShivaUtil.contextmenu.show() end, { desc = 'Content-aware menu' })
...
map('n', '<Leader>q', function() ShivaUtil.edit.toggle_list('quickfix') end, { desc = 'Open Quickfix' })
...
map('n', '<Leader>a', function()
	...
	ShivaUtil.edit.toggle_list('loclist')
